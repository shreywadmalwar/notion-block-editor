...
const STYLES = {
  [BlockType.HEADING1]: { tag: 'h1', className: 'text-[28px] font-bold leading-tight pt-6 pb-1' },
  [BlockType.HEADING2]: { tag: 'h2', className: 'text-[22px] font-semibold leading-tight pt-4 pb-1' },
  [BlockType.HEADING3]: { tag: 'h3', className: 'text-[18px] font-semibold leading-tight pt-3 pb-0.5' },
}
